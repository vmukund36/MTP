...
This stage quantifies the impact of prompt syntax on model safety.
* **Dataset:** A Synthetic Control dataset derived from 60 harmful instructions from the AdvBench benchmark.
* **Experimental Design:** Each instruction is evaluated across three syntactically distinct prompt formats:
